...
+ (void)goToAppStoreEvaluate
{
    ...
    {
        url = [NSURL URLWithString:@"itms-apps://ax.itunes.apple.com/WebObjects/MZStore.woa/wa/viewContentsUserReviews?type=Purple+Software&id=820128021"];
    }
    else
    {
        url = [NSURL URLWithString:@"itms-apps://itunes.apple.com/app/id820128021?at=10l6dK"];
    }
